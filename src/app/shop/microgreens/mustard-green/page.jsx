      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-12">
          ...
          <div>
            ...
            <div className="mb-6 space-y-1">
              <p className="text-lg">
                ...
                <span className="text-green-600">🌶️ Spicy, Peppery</span>
              </p>
              <p className="text-lg">
                <span className="font-semibold">Best For:</span> Salads,
                Chutneys, Tacos
              </p>
            </div>
            ...
            <div className="mt-6">
              <button
                onClick={() => handleOrderClick('Green Mustard Microgreens')}
        ...
        <div className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>Acts as an Anti-ageing agent</li>
            <li>Fights cholesterol</li>
            <li>Helps controlling Kidney problems</li>
          </ul>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border border-gray-300 text-left text-gray-700">
              ...
              <tbody>
                <tr><td className="py-2 px-4 border">Calcium</td><td className="py-2 px-4 border">32 mg</td></tr>
                <tr><td className="py-2 px-4 border">Carbohydrates</td><td className="py-2 px-4 border">2.1 gm</td></tr>
                <tr><td className="py-2 px-4 border">Dietary Fibre</td><td className="py-2 px-4 border">1.9 gm</td></tr>
                <tr><td className="py-2 px-4 border">Energy</td><td className="py-2 px-4 border">24 kcal</td></tr>
                <tr><td className="py-2 px-4 border">Iron</td><td className="py-2 px-4 border">1 mg</td></tr>
                <tr><td className="py-2 px-4 border">Magnesium</td><td className="py-2 px-4 border">27 mg</td></tr>
                <tr><td className="py-2 px-4 border">Potassium</td><td className="py-2 px-4 border">79 mg</td></tr>
                <tr><td className="py-2 px-4 border">Protein</td><td className="py-2 px-4 border">4 gm</td></tr>
                <tr><td className="py-2 px-4 border">Total Fat</td><td className="py-2 px-4 border">0.7 gm</td></tr>
                <tr><td className="py-2 px-4 border">Vitamin A</td><td className="py-2 px-4 border">155 iu</td></tr>
                <tr><td className="py-2 px-4 border">Vitamin C</td><td className="py-2 px-4 border">8.2 mg</td></tr>
              </tbody>
            </table>
          </div>
        </div>
