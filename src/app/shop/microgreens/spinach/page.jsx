...
export default function SpinachMicrogreens() {
          ...
          <div>
            ...
            <div className="mb-8 space-y-3">
              <p className="text-lg">
                ...
                <span className="text-green-700">🍃 Mild, Fresh</span>
              </p>
              <p className="text-lg">
                <span className="font-semibold">Best For:</span> Omelets, Dips, Smoothies
              </p>
            ...
            <table className="w-full border border-gray-300 text-left text-gray-700">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="py-2 px-4 border">34.6 mg</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border">Vitamin K</td>
                  <td className="py-2 px-4 border">815 µg</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border">Folate (B9)</td>
                  <td className="py-2 px-4 border">194 µg</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border">Iron</td>
                  <td className="py-2 px-4 border">2.7 mg</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border">Calcium</td>
                  <td className="py-2 px-4 border">99 mg</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border">Magnesium</td>
                  <td className="py-2 px-4 border">79 mg</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border">Potassium</td>
                  <td className="py-2 px-4 border">558 mg</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="relative w-full h-40 rounded-lg overflow-hidden shadow-md">
              <Image
                src="https://images.unsplash.com/photo-1606788075761-1a61e9b8c464?w=500&q=80"
            ...
            <div className="relative w-full h-40 rounded-lg overflow-hidden shadow-md">
              <Image
                src="https://images.unsplash.com/photo-1619566636858-758a4f2cae85?w=500&q=80"
            ...
            <div className="relative w-full h-40 rounded-lg overflow-hidden shadow-md">
              <Image
                src="https://images.unsplash.com/photo-1589927986089-35812388d1f4?w=500&q=80"
