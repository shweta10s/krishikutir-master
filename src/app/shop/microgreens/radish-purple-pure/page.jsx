...
export default function RadishPurplePure() {
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-12">
          ...
          <div>
            ...
            <div className="mb-6 space-y-1">
              <p className="text-lg text-gray-700">
                <span className="font-semibold">100g:</span> ₹315
              </p>
            </div>
            ...
            <div className="mb-8 space-y-3">
              <p className="text-lg">
                ...
                <span className="text-pink-700">🌶️ Zesty, Crisp</span>
              </p>
              <p className="text-lg">
                <span className="font-semibold">Best For:</span> Tacos, Avocado Toast
              </p>
        ...
        <div className="mb-12">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li>Radiates skin glow effects</li>
            <li>Fuels energy for the body & helps burn fat</li>
          </ul>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border border-gray-300 text-left text-gray-700">
              ...
              <tbody>
                <tr><td className="py-2 px-4 border">Calcium</td><td className="py-2 px-4 border">51 mg</td></tr>
                <tr><td className="py-2 px-4 border">Carbohydrates</td><td className="py-2 px-4 border">3.6 g</td></tr>
                <tr><td className="py-2 px-4 border">Dietary Fibre</td><td className="py-2 px-4 border">1.8 g</td></tr>
                <tr><td className="py-2 px-4 border">Energy</td><td className="py-2 px-4 border">4 kcal</td></tr>
                <tr><td className="py-2 px-4 border">Iron</td><td className="py-2 px-4 border">0.9 mg</td></tr>
                <tr><td className="py-2 px-4 border">Magnesium</td><td className="py-2 px-4 border">30 mg</td></tr>
                <tr><td className="py-2 px-4 border">Potassium</td><td className="py-2 px-4 border">86 mg</td></tr>
                <tr><td className="py-2 px-4 border">Protein</td><td className="py-2 px-4 border">3.8 g</td></tr>
                <tr><td className="py-2 px-4 border">Total Fat</td><td className="py-2 px-4 border">2.5 g</td></tr>
                <tr><td className="py-2 px-4 border">Vitamin A</td><td className="py-2 px-4 border">391 IU</td></tr>
                <tr><td className="py-2 px-4 border">Vitamin C</td><td className="py-2 px-4 border">28.9 mg</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      {showPopup && (
        <ProductPopup
          product="Radish Purple Pure Microgreens"
